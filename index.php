...
include "header.php";
$table =  $xoopsDB->prefix("irtibatplus_elements");

if ( empty($HTTP_POST_VARS['submit']) ) {
// make form
    $xoopsOption['template_main'] = 'irtibat_irtibatusform.html';
    include XOOPS_ROOT_PATH."/header.php";
    include_once XOOPS_ROOT_PATH."/class/xoopsformloader.php";

    $irtibat_form = new XoopsThemeForm(_CT_irtibatFORM, "irtibatform", "index.php");
    ...
    while ( list($id_element, $type, $caption, $name, $value, $parameter1, $parameter2, $ord, $req) = $xoopsDB->fetchRow($result) ) {
            ...
            $count++;
            $irtibat_form->addElement($element, $req);
            unset($element);
    }
    $submit_button = new XoopsFormButton("", "submit", _CT_SUBMIT, "submit");
    $irtibat_form->addElement($submit_button);
    $irtibat_form->assign($xoopsTpl);
...
// send mail
    ...
    $subject = $xoopsConfig['sitename']." - "._CT_irtibatFORM;
